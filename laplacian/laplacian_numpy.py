...
def kernel(A, B):
    for t in range(1, TSTEPS):
        ...
        temp_A[1:-1, 1:-1, 1:-1] = (0.125 * (temp_B[2:, 1:-1, 1:-1] - 2.0 * temp_B[1:-1, 1:-1, 1:-1] +
                            temp_B[:-2, 1:-1, 1:-1]) + 0.125 *
                            (temp_B[1:-1, 2:, 1:-1] - 2.0 * temp_B[1:-1, 1:-1, 1:-1] +
                            temp_B[1:-1, :-2, 1:-1]) + 0.125 *
                            (temp_B[1:-1, 1:-1, 2:] - 2.0 * temp_B[1:-1, 1:-1, 1:-1] +
                            temp_B[1:-1, 1:-1, 0:-2]) + temp_B[1:-1, 1:-1, 1:-1])
        
        B[1:-1, 1:-1, 1:-1] = temp_B[1:-1, 1:-1, 1:-1]
        A[1:-1, 1:-1, 1:-1] = temp_A[1:-1, 1:-1, 1:-1]
