...
DACE_EXPORTED void stencil_kernel_0_0(long long TSTEPS, double * __restrict__ fpga_A_0, double * __restrict__ fpga_B_0);
...
DACE_EXPORTED void __dace_runstate_0_stencil_kernel_0(stencil_kernel_state_t *__state, long long TSTEPS, hlslib::ocl::Buffer<double, hlslib::ocl::Access::readWrite> &fpga_A, hlslib::ocl::Buffer<double, hlslib::ocl::Access::readWrite> &fpga_B) {
    ...
    auto stencil_kernel_0_0_kernel = program.MakeKernel(stencil_kernel_0_0, "stencil_kernel_0_0", TSTEPS, fpga_A, fpga_B);
