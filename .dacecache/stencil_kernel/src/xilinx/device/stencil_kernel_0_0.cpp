...
void stencil_kernel_0_0_0(const double* __A_in, const double* __B_in, double* __A_out, double* __B_out, long long N) {
    #pragma HLS INLINE
    long long t;
...
void module_stencil_kernel_0_0(double *fpga_A, double *fpga_B, long long N) {

    stencil_kernel_0_0_0(&fpga_A[0], &fpga_B[0], &fpga_A[0], &fpga_B[0], N);
}

DACE_EXPORTED void stencil_kernel_0_0(double *fpga_A_0, double *fpga_B_0, long long N) {
    ...
    HLSLIB_DATAFLOW_FUNCTION(module_stencil_kernel_0_0, fpga_A_0, fpga_B_0, N);
